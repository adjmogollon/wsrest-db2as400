 ...
 * @author adjmo
 */
public class CorePreAfiliacion {

    private final String libreria = "LIBRARYNAME";
    private final String nombrePrograma = "WWWRP001";
    ...
    public CorePreAfiliacion() throws IOException {
    }

    public CorePreAfiliacion(String E_TRACE, String E_NACCLI, String E_CEDCLI) {
        try {
            /*
            ...
            */
            ...
            AS400Text txtRESPUESTA = new AS400Text(137);
            ...
            parmList[5] = new ProgramParameter(txtRESPUESTA.toBytes(""), 137);
            ...
            this.message = CorePreAfiliacion.class.getName() + " | " + ex.getMessage();
            Logger.getLogger(CorePreAfiliacion.class.getName()).log(Level.SEVERE, null, ex);
        } catch (Throwable ex) {
            this.message = CorePreAfiliacion.class.getName() + " | " + ex.getMessage();
            Logger.getLogger(CorePreAfiliacion.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    public String toString() {
        return "CorePreAfiliacion{" + "libreria=" + libreria + ", nombrePrograma=" + nombrePrograma + ", tipoPrograma=" + tipoPrograma + ", E_CANAL=" + E_CANAL + ", E_SERVICE=" + E_SERVICE + ", E_TRACE=" + E_TRACE + ", E_NACCLI=" + E_NACCLI + ", E_CEDCLI=" + E_CEDCLI + ", S_CODRES=" + S_CODRES + ", S_DESRES=" + S_DESRES + ", S_EMAIL1=" + S_EMAIL1 + ", S_EMAIL2=" + S_EMAIL2 + ", success=" + success + ", message=" + message + '}';
    }
